 ...
 * {@link ElectricalFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ElectricalFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ElectricalFragment extends android.support.v4.app.Fragment {
    ...
    View mainView;
    private MechanicalFragment.OnFragmentInteractionListener mListener;
    GridView gridView;
    ArrayList imageUrl;
    ...
    public static ElectricalFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainView = inflater.inflate(R.layout.fragment_electrical, container, false);
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (login.getStatus_code() != null) {
                                ...
                                if (login.getStatus_code().equals(Constants.status_code1)) {
                                    ...
                                    Log.e("ele size", String.valueOf(imageUrl.size()) + "," + String.valueOf(login.getName_array()));
